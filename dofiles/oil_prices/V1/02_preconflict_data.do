...
foreach country of global countries { // Open loop countries
	...
	* Loading the data	
	if "`country'" == "BGD" qui use "${country_path}\New_baseline\BGD_2026_6s_dom_yes_int_no_inc_no_cons_no_matching_yes_st_yes.dta", clear
	
	else if "`country'" == "MDV" qui use "${country_path}\Precrisis_covidtransfers\MDV_2026_6s_dom_no_int_no_inc_no_cons_no_matching_yes_st_yes.dta", clear
	...
	* Saving 
	order country hhid pid members male age h_head urban marital labor_rel* ypc_26 pondera_* fexp_* informal_* occupation_* icp* cpi* sect_* lai_* h_* new_ratio tot_lai_* 
...
/*=================================================================================================*/
	...
	* Variables used
	keep country hhid pid male age labor_rel* ypc_26 pondera_26 informal_26 occupation_26 members h_head urban  educat* marital region hogarsec baseline_yr aux_pondera_26 welfare* icp* cpi* sect_* lai_* h_* new_ratio tot_lai_* 
