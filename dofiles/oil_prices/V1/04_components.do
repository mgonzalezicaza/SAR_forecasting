...
use "${path}\Oil prices\input\compiled_SM2026_MPOweights", clear
	...
	* setting up the file
	keep country hhid pid fexp_s pc_inc_s pc_flai* pc_fnlai_s pc_transfers_s pc_ns_remit_s pc_dom_remit_s pc_int_remit_s pc_pensions_s pc_capital_s pc_otherinla_s pc_renta_imp_s welfare_s ratio_s
...
use "${path}\Oil prices\input\income_components_conflict", clear
merge 1:1 country hhid pid using "${path}\Oil prices\input\income_components_preconflict", nogenerate
